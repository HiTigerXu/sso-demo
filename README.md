...
{
    listen       80;
    server_name  sso.broker.a.com;
    charset      utf-8;
    root         /sso/examples/broker;
...
{
    listen       80;
    server_name  sso.broker.b.com;
    charset      utf-8;
    root         /sso/examples/brokers;
    index  index.html index.htm index.php;
...
{
    listen       80;
    server_name  sso.broker.service.com;
    charset      utf-8;
    root         /sso/examples/server;
    index  index.html index.htm index.php;
...
# 前端资源
 ...
 {
     listen         80;
     server_name    sso.java.sso.com;
     charset        utf-8;
     root           /sso/examples/ajax-broker;
     index          index.html index.htm index.php;
